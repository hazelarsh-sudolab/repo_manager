...
ARCHCCFLAGS	:= -mno-hw-mul -mno-hw-div -I "C:/intelFPGA_lite/18.1/nios2eds/components/altera_nios2/HAL/inc/" -DSYSTEM_BUS_WIDTH=32 -DALT_SINGLE_THREADED -D_JTAG_UART_BASE=8256u
...
# Files
HDRS		:=
SRCS		:= openlab.c amp/lib/src/niosII_jtag_uart.c
OBJS		:= $(patsubst %, %.o, $(SRCS))

# Targets
COMPILE: openlab.srec

openlab.srec: openlab.elf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@
...
CLEAN: 
	$(RM) openlab.srec openlab.elf $(OBJS)
