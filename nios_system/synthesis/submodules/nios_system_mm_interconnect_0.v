...
module nios_system_mm_interconnect_0 (
		...
		input  wire [12:0] nios_instruction_master_address,        //          nios_instruction_master.address
	...
	wire  [89:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> HEX0_s1_agent:cp_data
	...
	wire  [13:0] gpio0_s1_agent_m0_address;                                                  // GPIO0_s1_agent:m0_address -> GPIO0_s1_translator:uav_address
	...
	wire  [90:0] gpio0_s1_agent_rf_source_data;                                              // GPIO0_s1_agent:rf_source_data -> GPIO0_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] gpio0_s1_agent_rsp_fifo_out_data;                                           // GPIO0_s1_agent_rsp_fifo:out_data -> GPIO0_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                      // cmd_mux_006:src_valid -> GPIO0_s1_agent:cp_valid
	wire  [89:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> GPIO0_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                      // GPIO0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> GPIO0_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                              // cmd_mux_006:src_startofpacket -> GPIO0_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                // cmd_mux_006:src_endofpacket -> GPIO0_s1_agent:cp_endofpacket
	...
	wire  [89:0] hex0_s1_agent_rp_data;                                                      // HEX0_s1_agent:rp_data -> router_007:sink_data
	...
	wire         gpio0_s1_agent_rp_valid;                                                    // GPIO0_s1_agent:rp_valid -> router_008:sink_valid
	wire  [89:0] gpio0_s1_agent_rp_data;                                                     // GPIO0_s1_agent:rp_data -> router_008:sink_data
	wire         gpio0_s1_agent_rp_ready;                                                    // router_008:sink_ready -> GPIO0_s1_agent:rp_ready
	wire         gpio0_s1_agent_rp_startofpacket;                                            // GPIO0_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         gpio0_s1_agent_rp_endofpacket;                                              // GPIO0_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         gpio0_s1_agent_rdata_fifo_src_valid;                                        // GPIO0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] gpio0_s1_agent_rdata_fifo_src_data;                                         // GPIO0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         gpio0_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_006:in_0_ready -> GPIO0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                          // avalon_st_adapter_006:out_0_valid -> GPIO0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                           // avalon_st_adapter_006:out_0_data -> GPIO0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                          // GPIO0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                          // avalon_st_adapter_006:out_0_error -> GPIO0_s1_agent:rdata_fifo_sink_error
